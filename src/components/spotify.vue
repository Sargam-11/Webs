<template>
	<main class="spotflex">
		<a
			target="_blank"
			class="logo"
			href="https://open.spotify.com/user/31cxtinewjk3pwgbxwplhgkt6sfa?si=12d2767c610041ca"
			title="Now listening"
		...
		<div id="spotifycontainer">
			...
			<h5 class="title not" v-else>
				<a href="https://open.spotify.com/user/31cxtinewjk3pwgbxwplhgkt6sfa?si=12d2767c610041ca" target="_blank"
